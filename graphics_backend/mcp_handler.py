...
class MCPCommandHandler:
    ...
    def handle_batch_commands(
        ...
        for cmd_data in commands:
            ...
            if not command:
                results.append({"success": False, "error": "Missing command field"})
                continue
    ...
    def _cmd_create_circle(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        obj_id = params.get(
            "object_id", f"circle_{len(self.scene_manager.list_objects())}"
        )
    ...
    def _cmd_create_rectangle(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        obj_id = params.get(
            "object_id", f"rectangle_{len(self.scene_manager.list_objects())}"
        )
    ...
    def _cmd_create_triangle(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        obj_id = params.get(
            "object_id", f"triangle_{len(self.scene_manager.list_objects())}"
        )
    ...
    def _cmd_create_line(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        obj_id = params.get(
            "object_id", f"line_{len(self.scene_manager.list_objects())}"
        )
        ...
        result = {"object_id": obj_id, "type": "line", "style": style}
    ...
    def _cmd_create_ellipse(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        obj_id = params.get(
            "object_id", f"ellipse_{len(self.scene_manager.list_objects())}"
        )
        ...
        try:
            ...
            composite_curve = CompositeCurve(
                [TrimmedImplicitCurve(ellipse_curve, lambda px, py: True)], (x, y)
            )
    ...
    def _cmd_get_object_parameters(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if hasattr(obj, "get_parameters"):
            ...
            parameter_names = (
                obj.list_parameters() if hasattr(obj, "list_parameters") else []
            )
    ...
    def _cmd_create_multi_parameter_animation(
        ...
        return {
            ...
            "frame_count": len(next(iter(animations.values()))["values"])
            if animations
            else 0,
        }
    ...
    def _cmd_add_to_group(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"group_name": group_name, "object_id": object_id, "added": True}
    ...
    def _cmd_remove_from_group(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"group_name": group_name, "object_id": object_id, "removed": True}
    ...
    def _cmd_get_dependencies(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"object_id": obj_id, "dependencies": deps}
    ...
    def _cmd_get_command_info(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"command": command, "description": docstring.strip(), "available": True}
