...
class TestMCPCommandHandler:
    ...
    def test_get_object_info(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "scene.get_object_info", {"object_id": "circle1"}
        )
    ...
    def test_remove_object(self, handler_with_objects):
        ...
        # Remove object
        result = handler_with_objects.handle_command(
            "object.remove", {"object_id": "circle1"}
        )
        assert result["success"] is True
    ...
    def test_get_object_style(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "object.get_style", {"object_id": "circle1"}
        )
    ...
    def test_set_object_style(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "object.set_style", {"object_id": "circle1", "style": new_style}
        )
        ...
        style_result = handler_with_objects.handle_command(
            "object.get_style", {"object_id": "circle1"}
        )
    ...
    def test_get_object_parameters(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "object.get_parameters", {"object_id": "circle1"}
        )
    ...
    def test_create_multi_parameter_animation(self, handler_with_objects):
        ...
        animations = {
            "circle1": {"parameter_name": "radius", "values": [1.0, 2.0, 1.0]},
            "rect1": {"parameter_name": "width", "values": [2.0, 4.0, 2.0]},
        }

        result = handler_with_objects.handle_command(
            "animation.create_multi_parameter", {"animations": animations}
        )
    ...
    def test_render_scene_image(self, mock_close, mock_savefig, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "render.scene_image",
            {"bounds": [-3, 5, -3, 5], "resolution": [400, 300], "show_grid": True},
        )
    ...
    def test_get_curve_paths(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "render.get_curve_paths", {"bounds": [-2, 4, -2, 4], "resolution": 100}
        )
    ...
    def test_get_field_data(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "render.get_field_data", {"bounds": [-2, 4, -2, 4], "resolution": [20, 20]}
        )
    ...
    def test_get_region_data(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "render.get_region_data", {"bounds": [-2, 4, -2, 4], "resolution": [20, 20]}
        )
    ...
    def test_get_scene_bounds(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "render.get_scene_bounds", {"padding": 0.2}
        )
    ...
    def test_create_group(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "group.create",
            {"group_name": "test_group", "object_ids": ["circle1", "rect1"]},
        )
    ...
    def test_add_to_group(self, handler_with_objects):
        ...
        # Create group first
        handler_with_objects.handle_command(
            "group.create", {"group_name": "test_group", "object_ids": []}
        )

        # Add object to group
        result = handler_with_objects.handle_command(
            "group.add_object", {"group_name": "test_group", "object_id": "circle1"}
        )
    ...
    def test_register_dependency(self, handler_with_objects):
        ...
        result = handler_with_objects.handle_command(
            "dependency.register", {"source_id": "circle1", "dependent_id": "rect1"}
        )
    ...
    def test_get_dependencies(self, handler_with_objects):
        ...
        # Get dependencies
        result = handler_with_objects.handle_command(
            "dependency.get", {"object_id": "circle1"}
        )
    ...
    def test_get_command_info(self, handler):
        ...
        result = handler.handle_command(
            "help.get_command_info", {"command": "create.circle"}
        )
    ...
    def test_get_command_info_unknown(self, handler):
        ...
        result = handler.handle_command(
            "help.get_command_info", {"command": "unknown.command"}
        )
    ...
    def test_missing_required_parameters(self, handler):
        ...
        for command, params in test_cases:
            ...
            assert result["success"] is False
            assert (
                "Missing required parameter" in result["error"]
                or "exactly 3 vertices" in result["error"]
            )
...
class TestMCPHandlerIntegration:
    ...
    def test_complete_scene_creation_workflow(self):
        ...
        # 1. Create objects
        circle_result = handler.handle_command(
            "create.circle",
            {
        ...
        rect_result = handler.handle_command(
            "create.rectangle",
            {
                "object_id": "main_rect",
                "center": [3, 3],
        ...
        # 2. Create group
        group_result = handler.handle_command(
            "group.create",
            {"group_name": "main_objects", "object_ids": ["main_circle", "main_rect"]},
        )
        assert group_result["success"] is True

        # 3. Register dependency
        dep_result = handler.handle_command(
            "dependency.register",
            {"source_id": "main_circle", "dependent_id": "main_rect"},
        )
        ...
        style_result = handler.handle_command(
            "object.set_style",
            {
                "object_id": "main_circle",
        ...
        curve_result = handler.handle_command(
            "render.get_curve_paths", {"bounds": bounds_result["data"]}
        )
        ...
        try:
            save_result = handler.handle_command("scene.save", {"filename": filename})
