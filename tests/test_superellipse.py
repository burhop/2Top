...
class TestSuperellipseEvaluation:
    ...
    def test_evaluate_squarish_superellipse(self):
        ...
        assert (
            self.square.evaluate(0.9, 0.9) > 0
        )  # Outside - was incorrectly expecting inside
...
class TestSuperellipseGradient:
    ...
    def test_gradient_symmetry(self):
        ...
        test_points = [(0.5, 0.3), (-0.5, 0.3), (0.5, -0.3), (-0.5, -0.3)]
...
class TestSuperellipseSpecializedMethods:
    ...
    def test_string_representations(self):
        ...
        assert (
            "superellipse" in circle_str.lower()
            or "abs" in circle_str.lower()
            or "|" in circle_str
        )
