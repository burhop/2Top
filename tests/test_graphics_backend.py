...
class TestGraphicsBackendInterface:
    ...
    def scene_manager(self):
        ...
        rectangle = factory.create_rectangle_region(
            (1, 1.25), (3, 2.75)
        )  # center (2,2), width 2.0, height 1.5
...
class TestGraphicsBackendIntegration:
    ...
    def test_circle_data_extraction_integration(self):
        ...
        sm.set_style(
            "test_circle", {"color": "blue", "fill_color": "lightblue", "alpha": 0.7}
        )
    ...
    def test_performance_with_high_resolution(self):
        ...
        sm.add_object(
            "r1", factory.create_rectangle_region((1, 1), (3, 3))
        )  # center (2,2), width 2, height 2
    ...
    def test_high_precision_polyline_intersection_refinement(self):
        ...
        parabola.xmin, parabola.xmax, parabola.ymin, parabola.ymax = (
            -2.0,
            2.0,
            -2.0,
            2.0,
        ...
        backend = GraphicsBackendInterface(sm)
        scene_data = backend.get_geometry_scene_data(
            resolution=100, bounds=(-2.0, 2.0, -2.0, 2.0)
        )
