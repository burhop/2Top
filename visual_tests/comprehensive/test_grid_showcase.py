...
def test_comprehensive_grid_showcase():
    ...
    try:
        ...
        plot_manager.plot_curve_contour(
            axes[0, 0], circle_curve, X, Y, title="Circle\\nx² + y² = 4", color="blue"
        )
        ...
        plot_manager.plot_curve_contour(
            axes[0, 3], parabola_curve, X, Y, title="Parabola\\ny = x²", color="blue"
        )
        ...
        plot_manager.plot_curve_contour(
            axes[1, 0], line_curve, X, Y, title="Line\\n2x + 3y = 1", color="green"
        )
...
def test_focused_showcases():
    ...
    fig, axes = plot_manager.setup_figure(
        2, 2, figsize=(10, 10), suptitle="Conic Sections Showcase"
    )
    ...
    fig, axes = plot_manager.setup_figure(
        2, 2, figsize=(10, 10), suptitle="Area Regions Showcase"
    )
