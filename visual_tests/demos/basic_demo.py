...
def demo_basic_curves():
    ...
    fig, axes = plot_manager.setup_figure(
        1, 3, figsize=(15, 5), suptitle="Basic Curves Demo"
    )
...
def demo_basic_regions():
    ...
    # Set up the plot
    fig, axes = plot_manager.setup_figure(
        1, 3, figsize=(15, 5), suptitle="Basic Regions Demo"
    )
...
def demo_containment_testing():
    ...
    region_results = grid_evaluator.test_specific_points(
        circle_region, test_points, "region"
    )
