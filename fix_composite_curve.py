...
init_match = re.search(
    r"def __init__\(self, segments: List\[TrimmedImplicitCurve\],\s*\n\s*variables: Tuple\[sp\.Symbol, sp\.Symbol\] = None\):",
    content,
)
...
'''
                content = (
                    content[:method_end] + validation_method + content[method_end:]
                )
