...
from .parametric_segment import (
    ParametricSegment, create_circle_arc, create_line_segment, 
    create_parabola_segment, create_ellipse_arc
)

def create_reliable_heart_shape(variables: Optional[Tuple[sp.Symbol, sp.Symbol]] = None) -> CompositeCurve:
    """
...
def create_reliable_egg_shape(variables: Optional[Tuple[sp.Symbol, sp.Symbol]] = None) -> CompositeCurve:
    """
    ...
    bottom_ellipse = create_ellipse_arc(
        center=(0, 0),
        a=2.0, b=1.0,          # Semi-major=2, semi-minor=1
...
def create_reliable_lens_shape(variables: Optional[Tuple[sp.Symbol, sp.Symbol]] = None) -> CompositeCurve:
    """
...
def create_reliable_d_shape(variables: Optional[Tuple[sp.Symbol, sp.Symbol]] = None) -> CompositeCurve:
    """
    ...
    straight_line = create_line_segment(
        start=(0, 1),
        end=(0, -1),
        variables=variables
    )
...
def create_reliable_square(corner1: Tuple[float, float] = (-1, -1),
